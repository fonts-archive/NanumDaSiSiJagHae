...
사용하는 `font-family`의 이름은 `NanumDaSiSiJagHae`입니다.

### HTML

```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fonts-archive/NanumDaSiSiJagHae/NanumDaSiSiJagHae.css" type="text/css"/>
```

### CSS `@Import`

```css
@import url('https://cdn.jsdelivr.net/gh/fonts-archive/NanumDaSiSiJagHae/NanumDaSiSiJagHae.css');
```
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fonts-archive/NanumDaSiSiJagHae/subsets/NanumDaSiSiJagHae-dynamic-subset.css" type="text/css"/>
```

### CSS

```css
@import url("https://cdn.jsdelivr.net/gh/fonts-archive/NanumDaSiSiJagHae/subsets/NanumDaSiSiJagHae-dynamic-subset.css");
```
...
```css
font-family: "NanumDaSiSiJagHae", -apple-system, BlinkMacSystemFont, "Segoe UI",Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif;
```
